...
This is a mathematical description of the current state (June 12, 2026) of the
...
\item Results that are not present in the repository were deleted. These are:
  ...
  Pointwise Multipliers~I (18.7--18.9), and Pointwise Multipliers~II
  (18.10) together with its positive-cone version --- and the quasi-algebra
  result of Section~19 (Proposition~19.1, Pointwise Multipliers~III) are
  formalized and documented in Sections~\ref{diracsec}, \ref{multsec}
  and~\ref{quasisec}.
...
At the date of this document (June 12, 2026) a full \lean{lake build}
succeeds (3459 jobs) and the project Lean files contain no \lean{sorry}, no
