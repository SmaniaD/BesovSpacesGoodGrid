...
\begin{enumerate}
  ...
  \item develop the pointwise-multiplier layer: the \lean{selfs} classes,
    ...
    multiplier characterization, and the non-Archimedean multiplier estimates,
    including their positive-cone versions.
\end{enumerate}
...
This section documents the directory \lean{GoodGrid/Multipliers/} (five
...
\begin{itemize}
  \item \lean{GoodGrid/Multipliers.lean} and \lean{GoodGrid/Multipliers/}:
    ...
    and \lean{NonArchimedeanPropertyPositiveStandalone.lean} (the
...
At the date of this document (June 9, 2026) a full \lean{lake build}
succeeds (3454 jobs) and the project Lean files contain no \lean{sorry}, no
\lean{admit}, and no project-local \lean{axiom} or \lean{constant}
declarations. The axioms of the main theorems --- the finite and infinite,
non-positive and positive non-Archimedean properties, namely
\begin{center}
\small
